  ...
  'fn':function(W,D){
    ...
    var create = function(tgt,html,func){
      ...
      var init = function(){
        ...
        var s = '';
        s += '<div style="border:1px solid #B1B1B1;background-color:#FEFEE9;color:#C40000;-webkit-border-radius: 6px;-moz-border-radius: 6px;border-radius: 6px;"><b style="display:block;font-weight:normal;margin:10px;"></b></div>';
        s += '<div style="margin-left:10px;height:10px;overflow:hidden;margin-top:-1px"><div style="font-family:SimSun;overflow:hidden;margin-top:-12px;font-size:20px;color:#B1B1B1">&#9670;</div><div style="font-family:SimSun;overflow:hidden;margin-top:-24px;font-size:20px;color:#FEFEE9">&#9670;</div></div>';
        s += '';
        o.innerHTML = s;
        var b = I.$(o,'tag','b')[0];
        b.innerHTML = html;
        ...
        tip.layer.style.left = (pr.x)+'px';
            tip.layer.style.top = (pr.y-sl.height+8)+'px';
