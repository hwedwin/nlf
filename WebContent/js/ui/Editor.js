 ...
 for(var i=0;i<cfg.toolbar.length;i++){
  ...
  switch(name){
   ...
   case 'forecolor':
    ...
    I.ui.Color.bind(a,{
     callback:function(){
      this.current.style.color=this.color;
      obj.doc.execCommand('forecolor',false,this.color);
     }
    });
    var b=I.insert('b',a);
    I.cls(b,'fa fa-sort-desc');
   ...
   case 'backcolor':
    var a=_tool(obj,name,function(a){});
     I.ui.Color.bind(a,{
      callback:function(){
       this.current.style.color=this.color;
       obj.doc.execCommand('backcolor',false,this.color);
      }
     });
     var b=I.insert('b',a);
     I.cls(b,'fa fa-sort-desc');
   ...
   case 'link':
    _tool(obj,name,function(a){
     ...
     var win=I.z.Confirm.create({
      ...
      content:I.util.Template.render(null,'<div id="'+id+'"><ul><li data-width="20">URL：</li><li><input id="input'+id+'" type="text" /></li></ul><ul><li data-width="20">打开窗口：</li><li><select id="select'+id+'"><option value="_blank">新窗口</option><option value="_self">本窗口</option></select></li></ul><ul><li></li></ul></div>'),
      yes:function(){
       if(D.all){
     ...
     win.contentPanel.style.overflow='hidden';
    });
    break;
   case 'code':
    _tool(obj,name,function(a){
     ...
     var win=I.z.Confirm.create({
      ...
      yes_button_border_hover:'1px solid #269abc',
      yes_button_color_hover:'#FFF',
      content:I.util.Template.render(null,'<div id="'+id+'"><ul><li><textarea id="input'+id+'" style="height:130px;"></textarea></li></ul></div>'),
      yes:function(){
   ...
   case 'image':
    _tool(obj,name,function(a){
     ...
     var win=I.z.Confirm.create({
      ...
      yes_button_border_hover:'1px solid #269abc',
      yes_button_color_hover:'#FFF',
      content:I.util.Template.render(null,'<div id="'+id+'"><ul><li data-width="10">URL：</li><li><input id="input'+id+'" type="text" /></li><li data-width="30">&nbsp;<div id="upload'+id+'"><i>本地上传</i><b></b><form><input type="file" /></form></div></li></ul></div>'),
      yes:function(){
       if(D.all){
