  ...
  'fn':function(W,D){
    ...
    var create = function(tgt,html,func){
      ...
      var init = function(){
        ...
        var s = '';
        s += '<div style="height:10px;overflow:hidden"><div style="font-family:SimSun;overflow:hidden;margin-top:0;font-size:20px;color:#B1B1B1">&#9670;</div><div style="font-family:SimSun;overflow:hidden;position:absolute;top:1px;font-size:20px;color:#FFF">&#9670;</div></div>';
        ...
        tip.layer.style.left = (pr.x)+'px';
            tip.layer.style.top = (pr.y+pr.height)+'px';
